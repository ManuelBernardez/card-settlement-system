...
namespace Progra3Card.Administrativo
{
    class Program
    {
        ...
        static void MostrarDetalleCompleto(int cuenta)
        {
            ...
            string sql = @"
                SELECT t.num_cuenta, t.numero_tarjeta, t.banco_emisor, t.saldo,
                    u.documento, u.nombre, u.apellido, u.email
                FROM tarjetas t
            ...
            if (reader.Read())
            {
                ...
                Console.WriteLine(reader["numero_tarjeta"] + " - " + reader["banco_emisor"]);
